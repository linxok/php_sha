        ...
        <div class="wrapper">
            ...
            <form class="form" action="result.php" method="post">
                ...
                <ul style="list-style-type:number">
                    ...
                    <input type="radio" name="question1" value="0" checked><label>Public Hosting Platform</label><br>
                    ...
                    <input type="radio" name="question2" value="1" checked><label>$name</label><br>
                    ...
                    <input type="radio" name="question3" value="0" checked><label>display</label><br>
                    ...
                    <input type="radio" name="question4" value="0" checked><label>for</label><br>
                    ...
                    <input type="radio" name="question5" value="1" checked><label>mysqli_connect</label><br>
                    ...
                    <input type="radio" name="question6" value="0" checked><label>PHP Database Object</label><br>
                    ...
                    <input type="radio" name="question7" value="0" checked><label>Public Hosting Platform</label><br>
                    ...
                    <input type="radio" name="question8" value="0" checked><label>/*</label><br>
